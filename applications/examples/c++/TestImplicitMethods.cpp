...
#include "mechanics/timeIntegration/BDF.h"
#include "mechanics/timeIntegration/ImplicitEuler.h"
...
{
public:
    HarmonicOscillator(double freq)
        : k(4. * M_PI * M_PI * freq * freq)
    {
    }
...
{
public:
    HarmonicOscillatorJacobian(double k)
        : k(k)
    {
    }
